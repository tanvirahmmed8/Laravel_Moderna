					...
					<div class="row">
						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br/>
									<form method="POST" action="{{route('backend.post.store')}}" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                        @csrf
                                        <div class="row">
                                            <div class="col-lg-10">
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea name="post_body" class="form-control" id="descr" style="height:250px"></textarea>
                                                            @error('post_body')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="item row">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        @foreach ($cat_data as $item)
                                                            <p><input type="checkbox" name="categories[]" id="cat_{{$item->id}}" value="{{$item->id}}">
                                                                <label for="cat_{{$item->id}}"> {{$item->name}}</label></p>    
                                                            @endforeach
                                                        @error('categories')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
